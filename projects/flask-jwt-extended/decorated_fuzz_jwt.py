...
import atexit
create_access_token = decorate_module(create_access_token)
decode_token = decorate_module(decode_token)
jwt_required = decorate_module(jwt_required)
JWTManager = decorate_module(JWTManager)
verify_jwt_in_request = decorate_module(verify_jwt_in_request)
