...
import atexit
defusedxml.pulldom = decorate_module(defusedxml.pulldom)
defusedxml.minidom = decorate_module(defusedxml.minidom)
defusedxml.expatbuilder = decorate_module(defusedxml.expatbuilder)
